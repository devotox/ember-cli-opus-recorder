...
return function(){return e.apply(this,arguments)}}(),createNewRecorder:function(){var e=r(regeneratorRuntime.mark(function e(){var n,r,i=this
return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=this.encoderPath,(r=new t.default(Object.assign({encoderPath:n},this.recorderOptions))).ondataavailable=function(e){i.recorderData=new a([e],{type:i.audioElementType})},this.set("recorder",r),e.abrupt("return",r)
